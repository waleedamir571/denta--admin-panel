...
<body>
    ...
    <div class="startbar d-print-none">
        ...
        <div class="brand">
            <a href="" class="logo">
                <span>
                    <img src="assets/images/home/favicon-32x32.png" alt="logo-small" class="logo-sm">
                </span>
                <span class="">
                    <img src="assets/images/home/logo.svg" alt="logo-large" class="logo-lg logo-light">
                    <img src="assets/images/home/logo-DT.png" alt="logo-large" class="logo-lg logo-dark">
                </span>
            </a>
        </div>
        <!--end brand-->
            ...
            <div class="startbar-collapse" id="startbarCollapse" data-simplebar>
                <div class="d-flex align-items-start flex-column w-100">
                    ...
                    <ul class="navbar-nav mb-auto w-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="all-trainers.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none">
                                    <path d="M3 16.5L12 21.75L21 16.5" stroke="#8C94A3" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
