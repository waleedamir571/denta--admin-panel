                                    ...
                                    <div class="card-body">
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <div class="col-9">
                                                ...
                                                <p class="text-muted text-uppercase mb-0 fw-normal fs-13">Enrolled
                                                    Courses</p>
                                            </div>
                                            <!--end col-->
                                    ...
                                    <div class="card-body">
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <div class="col-9">
                                                ...
                                                <p class="text-muted text-uppercase mb-0 fw-normal fs-13">Active Courses
                                                </p>
                                            </div>
                                            <!--end col-->
                                    ...
                                    <div class="card-body">
                                        <div class="row d-flex justify-content-center">
                                            ...
                                            <div class="col-9">
                                                ...
                                                <p class="text-muted text-uppercase mb-0 fw-normal fs-13">USD Total
                                                    Earning</p>
                                            </div>
                                            <!--end col-->
                                    ...
                                    <div class="card-body">
                                        <div class="row d-flex justify-content-center">
                                            <div class="col-3 align-self-center">
                                                <div
                                                    class="d-flex justify-content-center align-items-center thumb-md border-dashed border-primary rounded mx-auto">
                                                    <img src="assets/images/home/bookings.png" alt="">
                                                </div>
                                            </div>
                                            <div class="col-9">

                                                <h4 class="mt-1 mb-0 fw-medium">36</h4>
                                                <p class="text-muted text-uppercase mb-0 fw-normal fs-13">Total Booking</p>
                                            </div>
                                            <!--end col-->
                                    ...
                                    <div class="card-body">
                                        <div class="row d-flex justify-content-center">
                                            <div class="col-3 align-self-center">
                                                <div
                                                    class="d-flex justify-content-center align-items-center thumb-md border-dashed border-primary rounded mx-auto">
                                                    <img src="assets/images/home/total-earnings.png" alt="">
                                                </div>
                                            </div>
                                            <div class="col-9">

                                                <h4 class="mt-1 mb-0 fw-medium">$7,461,767</h4>
                                                <p class="text-muted text-uppercase mb-0 fw-normal fs-13">USD Total Earning</p>
                                            </div>
                                            <!--end col-->
